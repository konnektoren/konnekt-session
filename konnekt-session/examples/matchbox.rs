...
/// source: https://github.com/johanhelsing/matchbox/blob/main/examples/simple/src/main.rs
///
/// run with `cargo run --example matchbox`
/// then test with `wasm-pack test --firefox --headless`
...
async fn async_main() {
    ...
    let (mut socket, loop_fut) = WebRtcSocket::new_reliable(
        "wss://match.konnektoren.help/ac2965a1-87c2-432a-aa9f-1f63319b193b",
    );
