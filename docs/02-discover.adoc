...
image::images/create-join-lobby.svg[Create and Join Lobby Process, 1000, 600]
...
image::images/activity-lifecycle.svg[Activity Lifecycle, 1000, 600]
...
image::images/host-delegation.svg[Host Delegation, 1000, 600]
